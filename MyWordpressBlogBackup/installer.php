...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20221219_softwarejourneys_90329d697d5379169153_20221219184057_archive.zip';
        const ARCHIVE_SIZE       = '19751402';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '90329d6-19184057';
        const SECONDARY_PACKAGE_HASH = 'f429336-19184057';
        const VERSION            = '1.5.1';
